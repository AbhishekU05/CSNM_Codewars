...
troops = [
    ...
    Troops.prince, Troops.wizard, Troops.skeleton, Troops.knight
]
...
def logic(arena_data: dict):
    ...
    if elixr >= 9.8 and flag:
        if opp_troop_data:
            deploy_list.list_.append((deployable[0], (opp_troop_data[list(opp_troop_data.keys())[0]][0], 0)))
        else:
